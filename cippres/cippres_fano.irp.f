...
!      print*, e_couplings_cippres(:,:)
      ...
      open(unit=10,file='fano.out')   
        write(*,*)n_csf_cippres(ici2),ici2
      do i = 1, n_csf_cippres(ici2) 
        write(*,'(100(e24.16,1X))')  (e_couplings_cippres(i,j), twoe_couplings_cippres(i,j), j=ifanosta,ifanosta)
        write(10,'(100(e24.16,1X))') (e_couplings_cippres(i,j), twoe_couplings_cippres(i,j), j=ifanosta,ifanosta)
      enddo
      close(10)
