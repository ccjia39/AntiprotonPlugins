...
!      close(10)
  ...
  !/home/cjia/qptest/qp2/plugins/qppluginsjia/cippres/libs/stieltjes 
  call system('$QP_ROOT/plugins/qp_plugins_kao/cippres/libs/stieltjes/stieltjes < '//trim(finput))
